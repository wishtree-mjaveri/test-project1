...
const NoBorder = () => (
  <Card title="Card title" bordered={false}>
    <p>
      Various versions have evolved over the years, sometimes by accident. The point of using Lorem Ipsum as
    ...
    <p>
      ...
      a Latin professor at Hampden-Sydney College in Virginia, discovered the source.
    </p>
  </Card>
