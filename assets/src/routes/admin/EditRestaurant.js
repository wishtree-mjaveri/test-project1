...
import {Button, Input,TimePicker,Form,message, Upload,Tooltip,Spin,RangePicker} from 'antd'
...
<FormItem rules={[{ required: true, message: 'Please enter restaurant name!' },{max:200,message:"Restaurant name must be less than  to 200 characters"}]} label="Restaurant Name" name="restaurantName">
...
<FormItem rules={ [ { required: true, message: 'Please enter time!' },]} label="Restaurant Time" >
