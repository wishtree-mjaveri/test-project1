...
const GridImage = (props) => {
  ...
  switch (mediaList.length) {
    case 1:
      return (
        <div className="gx-gallery-item" onClick={handleCancel}>
          <img className="gx-img-fluid" src={mediaList[0].image} alt="post" />
        </div>
      );
    case 2:
      return (
        <div className="gx-gallery-grid gx-gallery-2" onClick={handleCancel}>
    ...
    case 3:
      return (
        <div className="gx-gallery-grid gx-gallery-3" onClick={handleCancel}>
          <div className="gx-gallery-item">
            <img className="gx-img-fluid" src={mediaList[0].image} alt="post" />
          </div>
          <div className="gx-gallery-item">
    ...
    case 4:
      return (
        <div className="gx-gallery-grid gx-gallery-4" onClick={handleCancel}>
          <div className="gx-gallery-item">
    ...
    default:
      return (
        <div className="gx-gallery-grid gx-gallery-4-more" onClick={handleCancel}>
          <div className="gx-gallery-item">
            <img src={mediaList[0].image} alt="post" />
          </div>
          <div className="gx-gallery-item">
