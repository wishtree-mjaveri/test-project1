...
const PropertiesItemCard = ({ data }) => {
  const {
    image, title, subTitle, name, date, isFeatured, prize, sqft, bedrooms, baths, area, more,
  } = data;
  return (
        ...
        <div className="gx-featured-content-left">
          ...
          <div className="ant-row-flex">
            <p className="gx-mr-3 gx-mb-1">
              <span className="gx-text-grey">Bedrooms:</span>
              {' '}
              {bedrooms}
            </p>
            <p className="gx-mr-3 gx-mb-1">
              <span className="gx-text-grey">Baths:</span>
              {' '}
              {baths}
            </p>
            <p className="gx-mr-3 gx-mb-1">
              <span className="gx-text-grey">Area:</span>
              {' '}
              {area}
            </p>
          ...
          <div className="ant-row-flex">
            <p className="gx-text-grey gx-mb-1">
              <i className="icon icon-user gx-fs-xs gx-mr-2 gx-d-inline-flex gx-vertical-align-middle" />
              {name}
            </p>
            <p className="gx-text-grey gx-ml-4 gx-mb-1">
              <i className="icon icon-datepicker gx-fs-xs gx-mr-2 gx-d-inline-flex gx-vertical-align-middle" />
              {date}
            </p>
          </div>
        </div>
