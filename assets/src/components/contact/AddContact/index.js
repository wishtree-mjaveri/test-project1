...
class AddContact extends React.Component {
  constructor(props) {
    ...
    const {
      id, thumb, name, email, phone, designation, selected, starred, frequently,
    } = props.contact;
    this.state = {
      id,
      thumb,
  ...
  render() {
    const {
      onSaveContact, onContactClose, open, contact,
    } = this.props;
    const {
      id, name, email, phone, designation, selected, starred, frequently,
    } = this.state;
