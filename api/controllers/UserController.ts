...
const messages = sails.config.messages;
  ...
  export function registration(req:any, res:any, next: Function):any {
  ...
  export function editUser(req:any, res:any, next: Function):any {
  ...
  export function uploadProfilePic(req:any, res:any, next: Function):any {
  ...
  export function getUserList(req:any, res:any, next: Function):any {
    Logger.verbose('UserController.getUser');
